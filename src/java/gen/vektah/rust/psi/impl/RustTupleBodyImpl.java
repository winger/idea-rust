...
public class RustTupleBodyImpl extends ASTWrapperPsiElement implements RustTupleBody {

  public RustTupleBodyImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitTupleBody(this);
