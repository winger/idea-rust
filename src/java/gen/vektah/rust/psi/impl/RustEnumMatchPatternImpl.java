...
public class RustEnumMatchPatternImpl extends ASTWrapperPsiElement implements RustEnumMatchPattern {

  public RustEnumMatchPatternImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitEnumMatchPattern(this);
    else super.accept(visitor);
  }

  @Override
  @NotNull
  public List<RustEnumMatchPattern> getEnumMatchPatternList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, RustEnumMatchPattern.class);
  }
