...
public class RustTypeDefinitionImpl extends ASTWrapperPsiElement implements RustTypeDefinition {

  public RustTypeDefinitionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitTypeDefinition(this);
