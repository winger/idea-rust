...
public class RustStandardArgImpl extends ASTWrapperPsiElement implements RustStandardArg {

  public RustStandardArgImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitStandardArg(this);
